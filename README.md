# Symulacja cyklu życia roju dronów
...
1. Wysłać sygnał1 do operatora w celu dodania dodatkowych platform startowych, co pozwala zwiększyć maksymalną liczbę dronów do **2 * N** egzemplarzy.  
2. Wysłać sygnał2 do operatora w celu zdemontowania platform startowych, ograniczając bieżącą maksymalną liczbę egzemplarzy o 50%.  
3. Wysłać sygnał3 do konkretnego drona (nawet tego w bazie podczas ładowania baterii) w celu wykonania **ataku samobójczego**. Jeżeli poziom naładowania baterii jest niższy niż 20%, dron ignoruje sygnał3.
